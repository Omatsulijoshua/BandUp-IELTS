...
class _SpeakingPracticeScreenState extends ConsumerState<SpeakingPracticeScreen> {
  ...
  final List<Map<String, dynamic>> _book11Test2Questions = [
    ...
    {
      'question': 'Do you think children should be encouraged to read books from an early age?',
      'audioAsset': 'q7.mp3',
      'duration': 5.0,
      'start': 0.0,
      'promptEnd': 5.0,
      'end': 5.0,
      'part': 3,
      'transcript': 'Yes, absolutely. Reading early in life enhances vocabulary acquisition, fosters imagination, and improves cognitive focus. It also instills a lifelong habit of learning and critical thinking.',
    },
    {
      'question': 'How has technology changed the way people read?',
      'audioAsset': 'q8.mp3',
      'duration': 5.0,
      'start': 0.0,
      'promptEnd': 5.0,
      'end': 5.0,
      'part': 3,
      'transcript': 'Technology has revolutionized reading by making digital e-books and audiobooks widely accessible on smartphones and e-readers. People can now carry entire libraries in their pockets and listen to books while commuting.',
    },
    {
      'question': 'What are the qualities of a good writer?',
      'audioAsset': 'q9.mp3',
      'duration': 5.0,
      'start': 0.0,
      'promptEnd': 5.0,
      'end': 5.0,
      'part': 3,
      'transcript': 'A great writer possesses compelling storytelling skills, strong vocabulary control, and the ability to evoke deep emotions in readers. They must also show originality and convey complex ideas with clarity.',
    },
    {
      'question': 'Do you think written media like newspapers will disappear in the future?',
      'audioAsset': 'q10.mp3',
      'duration': 5.0,
      'start': 0.0,
      'promptEnd': 5.0,
      'end': 5.0,
      'part': 3,
      'transcript': 'While traditional printed newspapers are declining due to instant digital news portals and social media, in-depth journalism itself will endure, though it will exist almost exclusively online.',
    },
    {
      'question': 'Should governments subsidize local authors and literature?',
      'audioAsset': 'q11.mp3',
      'duration': 5.0,
      'start': 0.0,
      'promptEnd': 5.0,
      'end': 5.0,
      'part': 3,
      'transcript': 'Yes, providing grants and subsidies for local authors helps preserve national culture, encourages artistic expression, and ensures that diverse literary voices are represented in society.',
    },
  ];
